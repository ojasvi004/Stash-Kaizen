...
import { LuMic as Mic, LuCpu as Cpu, LuDatabase as Database } from 'react-icons/lu';
      ...
      <section style={{ paddingTop: '10rem', paddingBottom: '5rem', borderBottom: '1px solid var(--color-divider)' }}>
        <div className="container">
          <div className="text-center" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            >
              See how Stash turns a simple voice command into a digital supply chain command.
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '8rem 0' }}>
        <div className="container">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
             {[
               { icon: <Mic size={32} />, step: "Step 01", title: "Operator speaks to Stash", desc: "The godown operator uses the microphone and speaks in their local language. They report stock arrivals, shipments, or tasks." },

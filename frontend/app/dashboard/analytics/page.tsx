    ...
    <div className="dashboard-wrapper">
      ...
      <div className="grid-2" style={{ gridTemplateColumns: "2fr 1fr" }}>
        <div className="dashboard-card">
          ...
          <div style={{ height: "350px", marginTop: "1.5rem", width: '100%', minWidth: 0, minHeight: 0 }}>
        ...
        <div className="dashboard-card">
          ...
          <div style={{ height: "350px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: '100%', minWidth: 0, minHeight: 0 }}>

  ...
  return (
    <div className="dashboard-wrapper">
      ...
      <div className="grid-3" style={{ gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
        ...
        {/* Sidebar List */}
        <div className="deliveries-panel" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', height: '500px' }}>
           <div className="dashboard-card deliveries-panel__list" style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              <h3 className="dashboard-card-title mb-4">Shipments</h3>
              <div className="deliveries-panel__items" style={{ flex: 1, overflowY: 'auto', paddingRight: '8px' }}>

"use client";
import { LuMic as Mic, LuBrain as Brain, LuZap as Zap, LuCheck as CheckCircle } from 'react-icons/lu';
...
const steps = [
  {
    number: "01",
    icon: Mic,
    title: "Speak to Stash",
    description: "Use the microphone to speak your instructions. No complex menus or typing needed.",
    details: ["Voice input", "No typing required", "Hindi/English/Hinglish"]
  },
  {
    number: "02",
    icon: Brain,
  ...
  },
  {
    ...
    description: "Stash updates inventory or places orders automatically.",
